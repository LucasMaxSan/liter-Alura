...
import com.alura.literalura.Model.Listas;
...
public class Principal {
    ...
    public void buscarLivroApi() {
        ...
        Listas dados = conversor.obterDados(json, Listas.class);
    ...
    public void listarLivrosPorIdioma() {
        ...
        List<Livros> livros = livroService.buscarLivrosPorIdioma(idiomaSelecionado);
        if (!livros.isEmpty()) {
